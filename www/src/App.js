        ...
        <div style={{textAlign: 'center'}}>
                    ...
                    <tr key={framework.id}>
                        ...
                        <td>
                            <button className="btn btn-primary"
                                    onClick={() => seleccionarFramework(framework, "Editar")}>Editar
                            </button>
                            {"  "}
                            <button className="btn btn-danger"
                                    onClick={() => seleccionarFramework(framework, "Eliminar")}>Eliminar
                            </button>
                        </td>
                    </tr>
                ))}
            ...
            <Modal isOpen={modalEliminar}>
                <ModalBody>
                    ...
                    Framework {frameworkSeleccionado && frameworkSeleccionado.nombre}?
                </ModalBody>
                <ModalFooter>
